...
public class ProductProductOdooModel : IOdooModel
{
    ...
    /// <summary>
    /// product_variant_image_ids - one2many - product.image (product_variant_id) <br />
    /// Required: False, Readonly: False, Store: True, Sortable: False <br />
    /// </summary>
    ...
    /// <summary>
    /// rating_ids - one2many - rating.rating <br />
    /// Required: False, Readonly: False, Store: False, Sortable: False <br />
    /// </summary>
    ...
    /// <summary>
    /// product_template_image_ids - one2many - product.image <br />
    /// Required: False, Readonly: False, Store: False, Sortable: False <br />
    /// </summary>
    ...
    public InventoryAvailabilityProductProductOdooEnum? InventoryAvailability { get; set; }
    ...
    /// <summary>
    /// dr_tab_ids - one2many - dr.product.tabs <br />
    /// Required: False, Readonly: False, Store: False, Sortable: False <br />
    ...
    /// <summary>
    /// dr_offer_ids - one2many - dr.product.offer <br />
    /// Required: False, Readonly: False, Store: False, Sortable: False <br />
    /// Help: Display in product detail page on website. <br />
    /// </summary>
    ...
    /// <summary>
    /// label_line_ids - one2many - product.label.line <br />
    /// Required: False, Readonly: False, Store: False, Sortable: False <br />
    ...
    /// <summary>
    /// tab_line_ids - one2many - product.tab.line <br />
    /// Required: False, Readonly: False, Store: False, Sortable: False <br />
